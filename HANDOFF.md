...
| 회차 | 모임일 | 문서 공개 |
|---|---|---|
| 5회차 · 다듬기 | 2026-08-11 | 8/11 오전 9시 |
| 6회차 · 배포 | 2026-08-12 | **8/11 오전 9시** (같이 공개) |

**두 회차 문서 모두 `draft: true` 이고 `openDate: '2026-08-11'` 입니다.**
`.github/workflows/auto-open-sessions.yml` 이 매일 아침 9시(KST)에 `main` 과 `dev` 양쪽에서 draft 를 풀어줍니다. 같은 날 두 개가 함께 열리는 것을 로컬 재현으로 확인했습니다.
