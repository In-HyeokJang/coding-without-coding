...
### 3단계 · GitHub에 DB 연동 코드 중간 저장하기 (Push)

오늘 어렵게 성공시킨 기능(또는 폼 화면)을 GitHub에 보관해 둡니다.

```
오늘 작업한 연동 기능 코드를 GitHub에 올려줘.
.env 파일은 올라가지 않게 확인하고, 커밋 메시지는 "4회차 DB 연동 기능 추가" 로 해줘.
```
